...
public class In {// 制定进货单
	...
	public void display(String Job, String name, String ID,
		...
		sales = SaReceipt;
		sales.setSalesType(SalesReceiptType.PURCHASE);
	...
	public void display(String Job, String name, String ID) {
		...
		try {
			...
			root = FXMLLoader.load(getClass().getResource("In.fxml"));
	...
	private void HandleSave(ActionEvent event) {
		...
		if (date == null || date.equals("")) {
			...
			String warning = "The date cannot be empty even if you want to save it as a draft.";
		...
		sales.setSalesType(SalesReceiptType.PURCHASE);// 设定单据的类型：进货单
