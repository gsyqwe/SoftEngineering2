...
public class Gift {// 新建赠送单
	...
	void display(String Job, String name, String ID,
	...
	public void display(String Job, String name, String ID) {
		...
		try {
			...
			root = FXMLLoader.load(getClass().getResource("Gift.fxml"));
	...
	private void HandleTI(ActionEvent event) throws RemoteException,
		...
		vo.setInventoryType(InventoryReceiptType.OVERFLOW);
		...
		if (mistake.equals("")) {
			...
			vo.setInventoryType(InventoryReceiptType.GIFT);
