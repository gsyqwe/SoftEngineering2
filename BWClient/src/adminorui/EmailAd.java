...
public class EmailAd {
	...
	public void display(String Job, String name,String ID) {
		...
		try {
			root = FXMLLoader.load(getClass().getResource("EmailAD.fxml"));
		} catch (IOException e) {
		...
		t4.setCellValueFactory(cellData -> new SimpleStringProperty(cellData.getValue().getTitle()));//标题
