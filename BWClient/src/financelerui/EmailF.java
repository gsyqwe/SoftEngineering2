...
public class EmailF {
	...
	public void display(String Job, String name, String ID) {
		...
		try {
			root = FXMLLoader.load(getClass().getResource("EmailF.fxml"));
		} catch (IOException e) {
		...
		t3.setCellValueFactory(cellData -> new SimpleStringProperty(""+cellData.getValue().getIsReaded()));// 阅读状况
